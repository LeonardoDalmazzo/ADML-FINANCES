...
namespace ADML_FINANCES.Data.Migrations
{
    ...
    [Migration("20260306121504_AddUserOwnershipAndImmersiveTour")]
    partial class AddUserOwnershipAndImmersiveTour
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ADML_FINANCES.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("TourAtivo")
                        .HasColumnType("INTEGER");

                    b.Property<int>("TourEtapa")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ADML_FINANCES.Data.EmpresaFrequente", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserId", "Nome")
                        .IsUnique();
